...
public enum CourseCode implements ResultCode {
    ...
    COURSE_GET_NOTEXISTS(false,31103,"该课程信息不存在！"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31104,"该课程信息不存在,禁止添加！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31105,"只允许选择第三级的课程课程计划关联视频！");
