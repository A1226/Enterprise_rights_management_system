...
public class MediaUploadService {
    ...
    public ResponseResult mergechunks(String fileMd5, String fileName, Long fileSize, String mimetype, String fileExt) {
        ...
        //文件路径保存相对路径
        String filePathLoad = fileMd5.substring(0,1) + "/" + fileMd5.substring(1,2) + "/" + fileMd5 + "/";
        mediaFile.setFilePath(filePathLoad);
    ...
    public ResponseResult sendProcessVideoMsg(String mediaId){
        //基础判断 查询一下数据库信息
        Optional<MediaFile> optionalFile = mediaFileRepository.findById(mediaId);
